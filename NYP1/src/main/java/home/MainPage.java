...
//        getMenu();
//        searchTab.click();
//        sendKeysTosearch.sendKeys("news");
//        sendKeysTosearch.click();
//        sendKeysTosearch.clear();
//        sendKeysTosearch.sendKeys("hfhdhjhgfdh");
//        sendKeysTosearch.clear();
//        sendKeysTosearch.sendKeys("hdhgfjhhfc");
...
//    @FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.Button")
    @FindBy(id = "welcome_continue")
